    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_new_voucher_save:
                ...
                BaasDocument doc = new BaasDocument("vtrack");
                doc.put("name", "Upload-Test");
                doc.put("type", "for_me");
                doc.put("dateOfReceipt", "2014.01.01");
                doc.put("dateOfexpiration", "2014.01.02");
                doc.put("receivedBy", "Callback-Agent");
                doc.put("archive", "false");
                doc.put("redeemedAt", "");
                doc.put("redeemedWhere", "");
